    ...
    <div className="w-screen min-h-screen bg-richblack-900 flex flex-col font-inter">
      ...
      <Routes>
        ...
        >
          ...
          {/* student-only cart route */}
          {user?.accountType === ACCOUNT_TYPE.STUDENT && (
            <Route path="dashboard/cart" element={<Cart />} />
          )}

          {/* enrolled courses available to any logged-in user; it will render student enrollments for students and instructor-created courses for instructors */}
